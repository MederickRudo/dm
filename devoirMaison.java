...
public class devoirMaison {
	...
	public static void main(String[] args) {
        ...
        */
        ...
        {
           if (nbretentative == 3) {
        	   System.out.println(" vous n'avez pas trouvé la bonne combinaison"); 
        	   resultat = 1; 
           }    
        ...
        if (resultat == 0)
                   ...
                   {
                    if (nbretentative == 3) {
                    	System.out.println(" vous n'avez pas trouvé la bonne combinaison"); resultat = 1; 
                    } 
                    ...
                    if (saisie > Chiffreatrouver3) {
                    	...
                    	if (saisie < Chiffreatrouver3) {
                    		System.out.println("Le chiffre saisi est trop bas !");
                        	 ...
                        	 System.out.println("Le chiffre saisi " + saisie + " est le bon chiffre. Bravo ! Vous avez trouvé le code"); 
                        	 nbretentative = 4;
                         } 
                        }
                    }
